...
<html lang="es">
  <head>
    ...
    <img class="img-fluid " width="100%" src="{{ asset('img/header.JPG') }}" alt="mi foto"><br>
      ...
      <br>
        <nav class="nav">
            <div> <a href="administrador" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Menu Admin</span> </a>
                ...
                <a href="noticias" class="nav_link"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Noticias</span></a>
                <a href="/curso" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i> <span class="nav_name">Cursos</span> </a>
