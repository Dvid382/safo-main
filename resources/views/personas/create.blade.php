...
<link href="{{asset('css/main.css')}}" rel="stylesheet" media="all">
        ...
        <div class="card card-5">
            ...
            <div class="card-body">
                <form method="POST" action="/personas" autocomplete="off">
                    @csrf
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="operador" name="operador">
                    ...
                    <div class="col-3">
                        <div class="input-group-desc">
                            <input class="input--style-5" type="text" hidden autocomplete="off" value="1" name="rol" id="rol">
